            ...
            <div className='container'>
                <div className='row my-0 my-xl-5'>
                    <div className='col-xl-8 col-lg-8 col-md-12 col-sm-12 my-xl-5 my-auto'>
                        ...
                        <a className={`btn ${props.theme === 'dark' ? 'btn-light' : 'btn-dark'} d-none d-lg-block rounded-pill btn-lg w-50 mt-3`} href={contentIntroduction.button_href}>{contentIntroduction.button_text}</a>
                    </div>
                    <div className='col-xl-4 col-lg-4 col-md-12 col-sm-12 text-center my-xl-5 my-auto'>
                        {Avatars.map(avatar =>
                            <img key={avatar.id}  className='img-thumbnail rounded-pill m-2' width={150} height={150} src={avatar.src} />
                        )}                                   
                        <a className={`btn ${props.theme === 'dark' ? 'btn-light' : 'btn-dark'} d-block d-lg-none rounded-pill btn-lg mt-3 w-50 mx-auto`} href={contentIntroduction.button_href}>{contentIntroduction.button_text}</a>
                    </div>
                </div> 
            </div>                   
        </section>
