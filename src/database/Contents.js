...
const contentIntroduction = new ContentIntroduction('Hello World, my name is','Harry Surya','Full-Stack Developer','Experienced for 5 years creating and designing website for several companies.','https://goo.gl/maps/RqFsQb1WF2reuUhk9','Vancouver, BC, Canada','About Me','#sectionAbout')
...
contentContact.addParagraph(uuidv4(),'Are you in search of a versatile and skilled full stack developer to join your team? Look no further! I\'m actively seeking exciting opportunities to contribute my expertise and passion for crafting exceptional digital experiences.');
contentContact.addParagraph(uuidv4(),'If you\'re interested in collaborating on innovative projects, discussing potential job opportunities, or simply want to connect and share ideas, I\'d love to hear from you. Feel free to reach out with me on [LinkedIn/GitHub/Email]. Let\'s create something amazing together!');
